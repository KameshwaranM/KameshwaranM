                ...
                <Grid templateColumns={['repeat(1, 1fr)', 'repeat(1, 1fr)', 'repeat(1, 1fr)', 'repeat(2, 1fr)']} pt="50px" >
                  ...
                  <GridItem w="100%" h="100%" data-aos="flip-right" data-aos-delay="200">
                    ...
                    <Box display="flex" alignItems="center" justifyContent={["center", "center", "center", "center", "flex-start"]}>
                      <Text color="#fbfbfb" width={["90%", "70%"]} pl={["0px", "0px", "0px", "15px", "0px"]} fontSize="s">Growing up, I was always intrigued by puzzles and logic problems. It was that same sense of curiosity and problem-solving that drew me to the world of web development. I realized that writing a piece of code is like solving a puzzle and the joy of seeing the end result is unparalleled.
